            ...
            <section className="mb-6">
                ...
                <div className=" p-6 rounded-lg flex flex-col md:flex-row">
                    <div className="md:w-1/2 space-y-4">
                        ...
                        <a href="https://wa.me/84012500700" className="bg-[#FFCB00]  text-white py-2 px-4 rounded-lg inline-block">Написать в WhatsApp</a>
                    </div>
                    <div className="md:w-1/2 mt-4 md:mt-0">
                        <iframe
                            src="https://yandex.ru/map-widget/v1/?ll=20.562922%2C54.747122&z=16&pt=20.562922,54.747122,pm2rdl"
                            width="100%"
                            height="300"
                            style={{ border: 0 }}
                            allowFullScreen=""
